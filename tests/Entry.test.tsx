...
const addEntry = (testProps) => {
  ...
  return { nameHeading, priceHeading, categoryHeading, editBtn, deleteBtn };
};

// TODO
describe("Entry.tsx", () => {
  const testProps: EntryType = { id: "1", name: "foo", price: 20, category: "bar", currency: "£" };
  it("should have headings that mention the item, price, and category, and buttons to edit and delete the entry", () => {
    const { nameHeading, priceHeading, categoryHeading, editBtn, deleteBtn } = addEntry(testProps);
